<div class="navigation">
    <div class="navigation-wrap">
        <a href="/" class="nav-logo"><img src="image\logo.png" loading="lazy" width="100" alt="Logo"></a>
        <div class="nav-block">
            ...
            <div class="nav-block-button">
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="button-nav">UITLOGGEN</a></div>
            </div>
        </div>
