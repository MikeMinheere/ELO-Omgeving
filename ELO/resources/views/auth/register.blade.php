<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="form">
        ...
        <!-- Class Name -->
        <x-text-input id="class_name" class="w-input" type="text" name="class_name" :value="old('class_name')" placeholder="Klasnaam" required autofocus autocomplete="class_name" />
