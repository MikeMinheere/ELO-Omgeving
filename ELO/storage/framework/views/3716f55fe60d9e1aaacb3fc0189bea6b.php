...
<div style="width: 1440px; height: 2092px; position: relative; background: white; font-family: 'Gabarito';">
  ...
  <div style="padding-top: 19px; padding-bottom: 19px; padding-left: 65px; padding-right: 64px; left: 477px; top: 608px; position: absolute; background: #318D7E; border-radius: 8px; overflow: hidden; justify-content: center; align-items: center; display: inline-flex">
